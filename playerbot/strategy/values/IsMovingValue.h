...
namespace ai
{
	...
	{
	public:
        IsMovingValue(PlayerbotAI* ai, std::string name = "is moving") : BoolCalculatedValue(ai, name) {}
	...
	{
	public:
        IsSwimmingValue(PlayerbotAI* ai, std::string name = "is swimming") : BoolCalculatedValue(ai, name) {}

...
namespace ai
{
	...
	{
	public:
        DistanceValue(PlayerbotAI* ai, std::string name = "distance") : FloatCalculatedValue(ai, name) {}
    ...
    {
    public:
        InsideTargetValue(PlayerbotAI* ai, std::string name = "inside target") : BoolCalculatedValue(ai, name) {}

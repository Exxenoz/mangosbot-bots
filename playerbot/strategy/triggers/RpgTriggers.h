...
namespace ai
{
    ...
    {
    public:
        NoRpgTargetTrigger(PlayerbotAI* ai, std::string name = "no rpg target", int checkInterval = 1) : Trigger(ai, name, checkInterval) {}
    ...
    {
    public:
        RpgTrigger(PlayerbotAI* ai, std::string name = "sub rpg", int checkInterval = 2) : FarFromRpgTargetTrigger(ai, name, checkInterval) {}

...
#define AI_VALUE(type, name) this->context->GetValue<type>(name)->Get()
#define AI_VALUE2(type, name, param) this->context->GetValue<type>(name, param)->Get()

#define AI_VALUE_LAZY(type, name) this->context->GetValue<type>(name)->LazyGet()
#define AI_VALUE2_LAZY(type, name, param) this->context->GetValue<type>(name, param)->LazyGet()

#define SET_AI_VALUE(type, name, value) this->context->GetValue<type>(name)->Set(value)
#define SET_AI_VALUE2(type, name, param, value) this->context->GetValue<type>(name, param)->Set(value)
#define RESET_AI_VALUE(type, name) this->context->GetValue<type>(name)->Reset()
#define RESET_AI_VALUE2(type, name, param) this->context->GetValue<type>(name, param)->Reset()
...
#define MEM_AI_VALUE(type, name) dynamic_cast<MemoryCalculatedValue<type>*>(this->context->GetUntypedValue(name))
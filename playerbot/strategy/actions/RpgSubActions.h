...
namespace ai
{
    ...
    {
    public:
        RpgEndQuestAction(PlayerbotAI* ai, std::string name = "rpg end quest") : RpgSubAction(ai, name) {}
    ...
    {
    public:
        RpgMountAnimAction(PlayerbotAI* ai, std::string name = "rpg mount anim") : Action(ai, name) {}
